...
CodeBehind="BloodBankProfile.aspx.cs" Inherits="IPA1.User.BloodBankProfile" %>
...
<div class="row-fluid">
        <div class="span12">
            <div class="widget">
                ...
                <table class="table table-borderless" style="margin-left:90px; width:85%;border-spacing:40px;" cellpadding="10px" cellspacing="20px">
                    <tr>
                        <td>
                            Profile Pic
                        </td>
                        <td>
                            <asp:Image ID="ImgProfilePic" runat="server" Height="210px" Width="214px"></asp:Image><br /><br />
