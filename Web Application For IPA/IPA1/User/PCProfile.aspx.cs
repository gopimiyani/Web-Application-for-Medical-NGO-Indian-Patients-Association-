...
namespace IPA1.User
{
    public partial class PCProfile : System.Web.UI.Page
    {
        ...
        void PharmaCompanyDetailDisplay()
        {
            if (Session["User_ID"] != null)
            {
                objRegistration.User_ID1 = Convert.ToInt16( Session["User_ID"].ToString() );
                objRegistration.GetDataSet_GetPharmaCompanyProfile();
                ...
                txtContactPerson.Text = objRegistration.Ds.Tables[0].Rows[0]["ContactPerson"].ToString();
                txtWebsite.Text = objRegistration.Ds.Tables[0].Rows[0]["Website"].ToString();
                ImgIdProof.ImageUrl = "~//IdProof//" + objRegistration.Ds.Tables[0].Rows[0]["IdProof"].ToString();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            objRegistration.ContactPerson1 = txtContactPerson.Text;
            objRegistration.Website1 = txtWebsite.Text;
