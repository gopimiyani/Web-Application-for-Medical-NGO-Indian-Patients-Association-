...
namespace IPA1.User
{
    public partial class VHospitalDetail : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/User/VHospitalServiceDetailForm.aspx");
        }
        ...
        void ViewHospitalServiceDetail()
        {
            if (HospitalDetail_ID != 0)
            {
                ...
                lblBillNo1.Text=objHPDetail.Ds.Tables[0].Rows[0]["BillNo"].ToString();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            objHPDetail.BillNo1 = Convert.ToInt16(lblBillNo1.Text);

            objHPDetail.User_ID1 = Convert.ToInt16(Session["User_ID"].ToString());
