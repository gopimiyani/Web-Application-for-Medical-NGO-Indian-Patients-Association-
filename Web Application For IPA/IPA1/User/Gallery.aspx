<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true"
 CodeBehind="Gallery.aspx.cs" Inherits="IPA1.User.Gallery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <!--/#gallery start -->
        <section id="portfolio" style="padding-top:100px;">
    <%
        ...
        <div class="container">
            ...
            <div class="text-center">
             ...
             <div class="portfolio-items">
               ...
               <% 
                  Response.Write("<img src=\"../Visitor/images/" + objImage.Ds.Tables[0].Rows[i]["ImageName"].ToString() + "\"  class=\"img-responsive\" Width=\"582px\" Height=\"175px\" />");
                   ...
                   %> 
                      <%--<asp:Image ID="Image1" runat="server" class="img-responsive" Width="582px" Height="175px"/>
                       ...
                       <% 
                                Response.Write("<a href=\"../Visitor/images/" + objImage.Ds.Tables[0].Rows[i]["ImageName"].ToString() + "\"  class=\"preview\" rel=\"prettyPhoto\">");
