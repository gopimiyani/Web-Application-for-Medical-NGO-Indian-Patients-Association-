...
namespace IPA1.User
{
    public partial class BloodBankProfile : System.Web.UI.Page
    {
        ...
        void BloodBankDetailDisplay()
        {
            if (Session["User_ID"] != null)
            {
                objRegistration.User_ID1 = Convert.ToInt16( Session["User_ID"].ToString() );
                objRegistration.GetDataSet_GetBloodBankProfile();
