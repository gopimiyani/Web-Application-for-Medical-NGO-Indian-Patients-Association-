...
namespace IPA1.User
{
    public partial class VHospitalServiceDetailForm : System.Web.UI.Page
    {
        ...
        void BindBillNo()
        {
            ...
            {
                lblBillNo1.Text = objHospitalDetail.Ds.Tables[0].Rows[0]["BillNo"].ToString();
            }
            else
            {
                lblBillNo1.Text = "1";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            objHospitalDetail.User_ID1 = Convert.ToInt16(Session["User_ID"].ToString());
            objHospitalDetail.Patient_ID1 = Convert.ToInt16(ddlPName.SelectedValue);
            objHospitalDetail.BillNo1 = Convert.ToInt16(lblBillNo1.Text);
            ...
            Response.Write("<script language='javascript'>window.alert('Hospital Service Detail Inserted successfully.');window.location='VHospitalDetail.aspx';</script>");
        ...
        {
            Response.Redirect("~/User/VHospitalDetail.aspx");
        }
