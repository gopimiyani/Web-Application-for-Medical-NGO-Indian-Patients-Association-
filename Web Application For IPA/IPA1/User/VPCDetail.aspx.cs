...
namespace IPA1.User
{
    public partial class VPCDetail : System.Web.UI.Page
    {
        ...
        void BindGrid()
        {
            objPCDetail.GetDataSet(Session["User_ID"].ToString(), txtSearch.Text);
        ...
        protected void btnNew_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/User/VPCDetailForm.aspx");
        ...
        {
            objPCDetail.GetDataSet(Session["User_ID"].ToString(), "");
