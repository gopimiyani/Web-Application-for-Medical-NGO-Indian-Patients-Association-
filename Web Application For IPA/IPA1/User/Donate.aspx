<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Donate.aspx.cs" Inherits="IPA1.User.Donate" %>
 ...
 <section id="get-in-touch" style="margin-top:50px;">
        <div class="container">
            <div class="section-header">
               ...
               <br />
                Make a difference by helping us and continue saving lives! 
...
<br>
    ...
    <section id="contact">
    <asp:Image ID="Image1" runat="server" style="height:410px; margin-top:50px;" ImageUrl="../Visitor/images/Donate1.jpg"></asp:Image>
     ...
     <%--   <asp:RequiredFieldValidator ID="rfvtxtPurpose0" ControlToValidate="txtAmount"
            ErrorMessage="*" ForeColor="Red"  ValidationGroup="Donate" runat="server" 
            Font-Size="Small">
