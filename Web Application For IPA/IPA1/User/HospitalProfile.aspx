<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="HospitalProfile.aspx.cs" Inherits="IPA1.User.HospitalProfile" %>
            ...
            <div class="widget">
                ...
                <table class="table table-borderless" style="margin-left:90px; width:85%;">
                    <tr>
                        ...
                        <td>
                            <asp:Image ID="ImgProfilePic" runat="server" Height="210px" Width="214px"></asp:Image><br />
