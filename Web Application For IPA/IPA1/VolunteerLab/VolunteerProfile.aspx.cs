...
namespace IPA1.VolunteerLab
{
    public partial class VolunteerProfile : System.Web.UI.Page
    {
        ...
        void VolunteerDetailDisplay()
        {
            if (Session["User_ID"] != null)
            {
                objRegistration.User_ID1 = Convert.ToInt16(Session["User_ID"].ToString());
                objRegistration.GetDataSet_GetVolunteerProfile();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("<script language='javascript'>window.alert('Updated Sucessfully');window.location='Dashboard.aspx';</script>");
