<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor/Visitor.Master" AutoEventWireup="true"
    CodeBehind="RequestForm.aspx.cs" Inherits="IPA1.Visitor.Request1" %>
            ...
            <div class="form-group">
                  <div class="form-inline">
                         ...
                         <asp:TextBox ID="txtName" runat="server" MaxLength="30" class="form-control" placeholder="Patient Name" ></asp:TextBox>
                            ...
                            ErrorMessage="*" ForeColor="Red" ValidationGroup="Submit" CssClass="label-validation"></asp:RequiredFieldValidator>
             </div>
                      </div>
                      </td>
