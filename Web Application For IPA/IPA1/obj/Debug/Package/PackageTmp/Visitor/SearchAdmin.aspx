...
CodeBehind="SearchAdmin.aspx.cs" Inherits="IPA1.Visitor.SearchAdmin" %>
...
<asp:MultiView ID="mvAdmin" runat="server" ActiveViewIndex="0">
        <asp:View ID="vAdmin" runat="server">
                ...
                <div style="margin-left:80px;font-size:">
                 <u>Note:</u> For Blood Requirement just call one of the below IPA associator basis on your area.
                 </div>
             <br />
