...
CodeBehind="GetInvolved1.aspx.cs" Inherits="IPA1.Visitor.GetInvolved1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <% BusLib.Common.Registration objRegistration = new BusLib.Common.Registration();
       BusLib.Common.Registration objRegRating = new BusLib.Common.Registration();%>
...
<cc:Rating ID="Rating1" AutoPostBack="true"  runat="server"
    StarCssClass="Star" WaitingStarCssClass="WaitingStar" EmptyStarCssClass="Star"
    FilledStarCssClass="FilledStar" ReadOnly="true">
</cc:Rating>

<%  
    objRegRating.User_ID1 = Convert.ToInt16(objRegistration.Ds.Tables[0].Rows[i]["User_ID"].ToString());
   objRegRating.GetHospital_Rating();
   if (objRegRating.Ds.Tables[0].Rows.Count>0)
   {
       int Rating = Convert.ToInt16(objRegRating.Ds.Tables[0].Rows[0]["per"].ToString());
       Rating1.CurrentRating = Rating / 2;
   }
   else
   {
...
--%>
                    ...
                    <cc:Rating ID="Rating2" AutoPostBack="true"  runat="server"
    StarCssClass="Star" WaitingStarCssClass="WaitingStar" EmptyStarCssClass="Star"
    FilledStarCssClass="FilledStar" ReadOnly="true">
</cc:Rating>
...
<%  
    objRegRating.User_ID1 = Convert.ToInt16(objRegistration.Ds.Tables[0].Rows[i]["User_ID"].ToString());
   objRegRating.GetBloodBank_Rating();
   if (objRegRating.Ds.Tables[0].Rows.Count>0)
   {
       int Rating = Convert.ToInt16(objRegRating.Ds.Tables[0].Rows[0]["per"].ToString());
       Rating1.CurrentRating = Rating / 2;
