<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="IPA1.User.Contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <!--/# get-in-touch start -->
        ...
        <section id="get-in-touch" style="margin-top:50px;padding-bottom:0px;padding-top:70px;">
        <div class="container">
