<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="IPA1.User.Home" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<!--/#main-slider start -->
        <section id="main-slider" style="padding-top:50px;">
        <div class="owl-carousel">


          <div class="item" style="background-image: url(../Visitor/images/slider/slide2.jpg);">
                <div class="slider-inner">
                    <div class="container" style="margin-left:760px;margin-top:20px;">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                  
                                  <h2><span style="color:White;text-align:justify">Make the right choice! <br>Help those who are in need.</span></h2>
                                 <a class="btn btn-primary btn-lg" href="../Visitor/RegistrationForm.aspx">Join Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
               ...
               <div class="item" style="background-image: url(../Visitor/images/slider/Donate.jpg);">
                <div class="slider-inner">
                    <div class="container" style="margin-left:810px;">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
              ...
              <div class="item" style="background-image: url(../Visitor/images/slider/blood.jpg);">
                <div class="slider-inner">
                        ...
                        <div class="carousel-inner" role="listbox">
                           ...
                           <%
                               if (objNews.Ds.Tables[0].Rows.Count > 0)
                               {
                                ...
                                <p>
                                <img class="img-circle img-thumbnail" src="../Visitor/images/News1.jpg" width="100px" height="100px" alt=""/></p>
                                ...
                                <% Response.Write(objNews.Ds.Tables[0].Rows[i]["NewsDescription"].ToString()); %>
                                     ...
                                     <% }
                                       else
                                       {
                                           %>
                             <div class="item">
                                <p><img class="img-circle img-thumbnail" src="../Visitor/images/News1.jpg"  width="100px" height="100px" alt=""/></p>
                                <h4>
                              <% Response.Write(objNews.Ds.Tables[0].Rows[i]["NewsTitle"].ToString()); %>
