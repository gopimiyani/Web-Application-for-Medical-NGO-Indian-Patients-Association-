<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="IPA1.User.Events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <!--/# Events start-->
        ...
        <!-- On Going Events if any -->
           ...
           padding-top:50px;margin-top:50px;padding-bottom:10px;">
   <div class="container">
