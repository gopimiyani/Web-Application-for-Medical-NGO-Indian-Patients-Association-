<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdmin.Master" AutoEventWireup="true"
    CodeBehind="ReportRequest.aspx.cs" Inherits="IPA1.SuperAdmin.ReportRequest" %>
                    ...
                    <div class="widget-body">
                        <div class="portlet-body">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="style8">
                                        <asp:Label runat="server" Text="RequestDate  From :" ID="lblJoinDateFrom"></asp:Label>
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="lblcvJoinDateTo" runat="server" ForeColor="Red" Text="RequestDate(From) can't be greater than RequestDate(To)!"
                                ...
                                <tr>
                                    <td class="style8">
                                        <asp:Label ID="lblPaymentStatus" runat="server" Text="Status"></asp:Label>
                                        <span class="style2"></span>
                                    </td>
                                    <td>
