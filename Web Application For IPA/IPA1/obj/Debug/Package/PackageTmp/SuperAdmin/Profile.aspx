<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="IPA1.SuperAdmin.Profile" %>
                        ...
                        <table class="table table-borderless" style="margin-left:20px; width:95%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="style3">
                                        <asp:Image ID="ImgProfilePic" runat="server" Height="168px" Width="221px"></asp:Image><br />
                                        <br />
                                ...
                                <tr>
                                    ...
                                    <td class="style5">
                                        <asp:TextBox ID="txtIpaddress" class="inputtext" runat="server" Width="210px" 
