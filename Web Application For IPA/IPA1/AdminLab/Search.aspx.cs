       ...
       // BusLib.Common.Registration objUserRegister = new BusLib.Common.Registration();
        ...
        void UserDetailDisplay()
        {
            if (User_ID != 0)
            {
                ...
                ddlUserType.SelectedItem.Text = objRegistration.Ds.Tables[0].Rows[0]["StackHolder"].ToString();
                txtFirstName.Text = objRegistration.Ds.Tables[0].Rows[0]["FirstName"].ToString() + " " + objRegistration.Ds.Tables[0].Rows[0]["LastName"].ToString();
                ...
                txtAddress.Text = objRegistration.Ds.Tables[0].Rows[0]["Address"].ToString() + ", " + objRegistration.Ds.Tables[0].Rows[0]["City"].ToString() + "- " + objRegistration.Ds.Tables[0].Rows[0]["PinCode"].ToString() + ", " + objRegistration.Ds.Tables[0].Rows[0]["State"].ToString();
        ...
        protected void btnSearch_Click1(object sender, EventArgs e)
        {
            if (ddlselecttype.Text != "" && txtPinCode.Text != "")
            {
                if (txtPinCode.Text != "")
                {
                    ...
                    //    Regex regx1 = new Regex(@"^[0-9][0-9]\?[0-9]\?[0-9]\?[0-9]\?[0-9]\?$");
                    //    if (regx1.IsMatch(txtPinCode.Text))
                    //    {
