<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLab/Home.Master" AutoEventWireup="true" CodeBehind="Report_Task.aspx.cs" Inherits="IPA1.AdminLab.Report_Task" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Report of Task</a> Detail<span class="divider-last">&nbsp;</span></li>
                </ul>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="space15">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td class="style8">
                                                <asp:Label runat="server" Text="EntryDate  From :" ID="lblJoinDateFrom"></asp:Label>
