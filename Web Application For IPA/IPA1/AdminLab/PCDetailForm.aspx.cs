...
{
    public partial class PCDetailForm : System.Web.UI.Page
    {
        ...
        void FillddlPharmaCompanyName()
        {
            ...
            ddlPCName.Items.Add(new ListItem("--Select PharmaCompany Name | ID--", ""));
        ...
        void FillddlPatientName()
        {
            ...
            ddlPatientName.Items.Add(new ListItem("--Select Name | ID--", ""));
            if (ddlPCName.SelectedIndex != 0)
            {
                objPatient.ServiceProviderUser_ID1 = Convert.ToInt16(ddlPCName.SelectedValue);
        ...
        {
            Response.Redirect("~/AdminLab/PharmaCompanyDetail.aspx");
        }
        ...
        protected void ddlPCName_SelectedIndexChanged1(object sender, EventArgs e)
        {
            if (ddlPCName.SelectedIndex == 0)
            {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //   objPCDetail.GetMaxID();
            //  int PCDetail_ID=Convert.ToInt16( objPCDetail.Ds.Tables[0].Rows[0]["PharmaCompanyDetail_ID"].ToString() );
            DataTable tb = (DataTable)Session["dt"];
            ...
            string url = "PharmaCompanyDetail.aspx";
