                                        ...
                                        <br />
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtAmount" runat="server" Font-Bold="False" MaxLength="8" CssClass="inputtext"
                                                    ...
                                                    <td>
                                                     ...
                                                     <asp:Label ID="lblcvAmount" runat="server" ForeColor="Red" CssClass="label-validation">
                                                        ...
                                                        <asp:RangeValidator ID="RangeValidator1" runat="server" 
                                                            ErrorMessage="Donation Amount can not be less than 100 Rs." 
                                                            ValidationGroup="Submit" ControlToValidate="txtAmount" ForeColor="Red" 
                                                            MaximumValue="9999999999" MinimumValue="100"></asp:RangeValidator>
                                                    </td>
