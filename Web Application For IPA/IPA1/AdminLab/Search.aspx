<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLab/Home.Master" AutoEventWireup="true"
    CodeBehind="Search.aspx.cs" Inherits="IPA1.AdminLab.Search" %>
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="widget-title">
                                                <h4>
                                                    <i class="icon-reorder"></i>Search</h4>
                                    ...
                                    <div class="widget-body">
                                        <div class="portlet-body">
                                            <div class="clearfix">
                                                <div class="btn-group">
                                                    ...
                                                    <asp:CustomValidator ID="cvddlselecttype" runat="server" ForeColor="Red" 
                                                        OnServerValidate="cvddlselecttype_ServerValidate1"></asp:CustomValidator>
                                                    <br />
                                                </div>
                                                <br />
                                                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch">
                                                    ...
                                                    <%--<asp:RangeValidator ID="rvSearch" runat="server" ControlToValidate="txtPinCode" 
                                                        ErrorMessage="Invalid PinCode !" ForeColor="Red" MaximumValue="999999" 
                                                        MinimumValue="0" ValidationGroup="btnSearch"></asp:RangeValidator>--%>
                                                     <%--<asp:RegularExpressionValidator ID="reSearch" runat="server" ControlToValidate="txtPinCode"
                                                    ErrorMessage="PinCode must be at most 6 digit" ValidationExpression="^[0-9][0-9]\?[0-9]\?[0-9]\?[0-9]\?[0-9]\?$" ValidationGroup="btnSearch"
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <asp:GridView ID="gvUser" runat="server" AllowPaging="True" AllowSorting="True" 
                                                ...
                                                BorderWidth="1px" CellPadding="4" class="table table-striped table-hover" 
                                                DataKeyNames="User_ID" EnableModelValidation="True" ForeColor="#333333" 
                                                GridLines="Both" OnPageIndexChanging="gvUser_PageIndexChanging" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Address" SortExpression="Address">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtAddress" runat="server" class="inputtext" 
                                                    ...
                                                    <asp:TemplateField HeaderText="Contact No" SortExpression="MobileNo">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtContact" runat="server" class="inputtext" 
                                                                Text='<%#Eval("MobileNo") %>'></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfvContact" runat="server" 
                                                                ControlToValidate="txtContact" ErrorMessage="*" SetFocusOnError="True" 
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="search-input-area">
                                                            ...
                                                            <asp:TextBox ID="txtPinCode1" runat="server" Visible="False" BorderColor="White"
                                                    ...
                                                    <table>
                                                        <div>
                                                            <%
                                                                ...
                                                                Response.Write("<iframe  src=\"https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d1904939.4532538687!2d72.81017772!3d21.1689128!3m2!1i1024!2i768!4f13.1!2m1!1s" + txtAddress.Text + txtPinCode1.Text + "!5e0!3m2!1sen!2sin!4v1422699736554\" width=\"500\" height=\"500\" frameborder=\"0\" style=\"border:0\"></iframe>");    
                                                            %>
                                                        </div>
                                                    </table>
                                                </asp:View>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            <%
                                                                ...
                                                                Response.Write("<iframe  src=\"https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d1904939.4532538687!2d72.81017772!3d21.1689128!3m2!1i1024!2i768!4f13.1!2m1!1s" + txtFirstName.Text + "Hospital" + txtPinCode1.Text + "!5e0!3m2!1sen!2sin!4v1422699736554\" width=\"500\" height=\"500\" frameborder=\"0\" style=\"border:0\"></iframe>");    
                                                            %>
                                                        </div>
                                                    </table>
                                                </asp:View>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            <%
                                                                ...
                                                                Response.Write("<iframe  src=\"https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d1904939.4532538687!2d72.81017772!3d21.1689128!3m2!1i1024!2i768!4f13.1!2m1!1s" + txtFirstName.Text + "BloodBank" + txtPinCode1.Text + "!5e0!3m2!1sen!2sin!4v1422699736554\" width=\"600\" height=\"600\" frameborder=\"0\" style=\"border:0\"></iframe>");    
                                                            %>
                                                        </div>
                                                    </table>
                                                </asp:View>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            <%
                                                                ...
                                                                Response.Write("<iframe  src=\"https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d1904939.4532538687!2d72.81017772!3d21.1689128!3m2!1i1024!2i768!4f13.1!2m1!1s" + txtFirstName.Text + "Pharmaceutical" + txtPinCode1.Text + "!5e0!3m2!1sen!2sin!4v1422699736554\" width=\"500\" height=\"500\" frameborder=\"0\" style=\"border:0\"></iframe>");    
                                                            %>
                                                        </div>
                                                    </table>
                                                </asp:View>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            <%
                                                                ...
                                                                Response.Write("<iframe  src=\"https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d1904939.4532538687!2d72.81017772!3d21.1689128!3m2!1i1024!2i768!4f13.1!2m1!1s" + txtFirstName.Text + txtPinCode1.Text + "!5e0!3m2!1sen!2sin!4v1422699736554\" width=\"500\" height=\"500\" frameborder=\"0\" style=\"border:0\"></iframe>");    
                                                            %>
                                                        </div>
                                                    </table>
                                                </asp:View>
