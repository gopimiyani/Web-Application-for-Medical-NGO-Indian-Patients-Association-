<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLab/Home.Master" AutoEventWireup="true"
    CodeBehind="PatientRequestForm.aspx.cs" Inherits="IPA1.VolunteerLab.PatientRequestForm" %>
                        ...
                        <div class="portlet-body">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="style5">
                                        <asp:TextBox ID="txtDescr" runat="server" TextMode="MultiLine" MaxLength="100" Height="94px"
                                ...
                                <tr>
                                    <td class="style1">
                                        <asp:Label ID="lblDocument2" runat="server" Text="Disease Related Document 2"></asp:Label>
                                    ...
                                    <td>
                                        <asp:Label ID="lblcvDocument2" runat="server" ForeColor="Red" CssClass="label-validation"></asp:Label>
                                    </td>
                                </tr>
