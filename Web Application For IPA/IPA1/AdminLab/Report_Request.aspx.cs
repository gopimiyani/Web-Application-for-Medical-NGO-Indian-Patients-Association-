...
{
    public partial class Report_Request : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/AdminLab/Report_GetRequestDetail.aspx?FromDate=" + txtJoinDateFrom.Text + "&ToDate=" + ToDate + "&Pincode=" + txtPinCode.Text + "&State=" + ddlState.SelectedItem.ToString() + "&City=" + ddlCity.SelectedItem.ToString() + "&Status=" + ddlStatus.SelectedItem.ToString()+"");
        }
