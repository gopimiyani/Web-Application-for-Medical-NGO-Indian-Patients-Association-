...
{
    public partial class BloodBankDetail : System.Web.UI.Page
    {
        ...
        void BindGrid()
        {
            objBloodBank.GetDataSet(ddlBloodBankName.SelectedValue.ToString(),txtSearch.Text);
        ...
        void FillddlBloodBankName()
        {
            ...
            ddlBloodBankName.Items.Add(new ListItem("--Select Name | ID--", ""));
        ...
        void FillddlBloodBankName1()
        {
            objBloodBank.GetDataSet_GetBloodBankName();
            ddlBBName.Items.Add(new ListItem("--Select Name | ID--", ""));
            ddlBBName.DataSource = objBloodBank.Ds.Tables[0];
            ddlBBName.DataTextField = "Name";
            ddlBBName.DataValueField = "User_ID";
            ddlBBName.SelectedIndex = 0;
            ddlBBName.DataBind();
        ...
        void ViewBloodBankDetail()
        {
            if (BloodBankDetail_ID != 0)
            {
                ...
                ddlBloodBankName.Enabled = false;
                txtBillNo.Enabled = false;
                txtBloodBankDetail_ID.Text = objBloodBank.Ds.Tables[0].Rows[0]["BloodBankDetail_ID"].ToString();
                ddlBBName.SelectedValue = objBloodBank.Ds.Tables[0].Rows[0]["User_ID"].ToString();
        ...
        {
            Response.Redirect("~/AdminLab/BloodBankDetailForm.aspx");
        }
