                                ...
                                <div class="widget">
                                    ...
                                    <div style="color: Black">
                                        ...
                                        2. Click View button to view patient request detail.
                                          ...
                                          <asp:Panel ID="pServiceProvider" runat="server" Visible="false">
                                            <table>
                                            <tr>
                                            <td class="style2">
                                            
                                                <asp:Label ID="lblServiceProvider" runat="server" Text="Service Provider">
                                                </asp:Label>                 


                                            </td>
                                            <td class="style3">
                                                <asp:TextBox ID="txtServiceProvider" runat="server" Enabled="False"></asp:TextBox>                           
                                            </td>
