<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportTaskDetail.aspx.cs" Inherits="IPA1.SuperAdmin.ReportTaskDetail" %>
                ...
                <% if (tbTaskDetail.Rows.Count > 0)
                   {
                       for (int i = 0; i < tbTaskDetail.Rows.Count; i++)
                       {
                           ...
                           Response.Write("<td> " + tbTaskDetail.Rows[i]["AdminName"].ToString() + " </td>");
                           ...
                           if (tbTaskDetail.Rows[i]["ActualCompletionDate"].ToString() == "01-01-1900")
                           {
                               Response.Write("<td> " + "" + "<br/>" + tbTaskDetail.Rows[i]["ActualCompletionTime"].ToString() + " </td>");
