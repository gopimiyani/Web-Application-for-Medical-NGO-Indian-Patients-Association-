    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="widget" style="width:780px;">
         ...
         <asp:RequiredFieldValidator ID="rfvICode" runat="server" 
            ...
            ></asp:RequiredFieldValidator>
                                                ...
                                                <asp:TemplateField HeaderText="Terms and Condition" SortExpression="TermName">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblName" runat="server" Text='<%#Eval("TermName") %>' style="text-align:justify;"></asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtName" class="inputtext" runat="server" Text='<%#Eval("TermName") %>'
                                                            style="width:500px; text-align:justify;" TextMode="MultiLine"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName"
                                                            ValidationGroup="Update" ForeColor="Red" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                    </EditItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtIName" runat="server" class="inputtext" style="width:500px;" TextMode="MultiLine"></asp:TextBox>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnEdit" class="btn btn-info" Width="60px" runat="server" Text="Edit" CommandName="Edit" />
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
