...
namespace IPA1.SuperAdmin
{
    public partial class ReportRequest : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/SuperAdmin/ReportRequestDetail.aspx?WorkingAdmin_ID="+ddlAName.SelectedValue+"&FromDate=" + txtJoinDateFrom.Text + "&ToDate=" + ToDate+ "&Pincode=" + txtPinCode.Text + "&State=" + ddlState.SelectedItem.ToString() + "&City=" + ddlCity.SelectedItem.ToString() + "&Status=" + ddlStatus.SelectedItem.ToString() + "");
        }
